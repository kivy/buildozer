...
RUN wget https://www.crystax.net/download/crystax-ndk-10.3.1-linux-x86_64.tar.xz?interactive=true -O ~/.buildozer/crystax.tar.xz && cd ~/.buildozer/ && \
tar -xvf crystax.tar.xz
